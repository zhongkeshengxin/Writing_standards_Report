...
2. 项目审核共有两次，分别为：分析部审核->方案部审核。每次审核不通过都要按要求修改后重新提交审核，最后方案审核通过后才可以进行结果交付；
3. 终审通过后，需要将结果打包上传到服务器 /data/nas2/project_results 目录下，此处需要做到一下几点：
...
![image](https://user-images.githubusercontent.com/53322640/183338938-55eb4490-16dd-4a06-bdbd-b486a566e5e3.png)
